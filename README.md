...
**Agent Cards are the identity and discovery layer for autonomous agents — binding canonical verbs to verifiable execution.** Execution resolves by through an x402 entrypoint — standards-first, no proprietary routing required.
