...
export const cleanAgentCard: AgentCard = {
  ...
  description:
    "Cleans or normalizes content using the CommandLayer Commons v1.0.0 clean verb.",
  ...
  capabilities: [
    {
      ...
      schema_request:
        "https://commandlayer.org/schemas/v1.0.0/commons/clean/requests/clean.request.schema.json",
      schema_receipt:
