...
export const classifyAgentCard: AgentCard = {
  ...
  description:
    "Classifies content using the CommandLayer Commons v1.0.0 classify verb.",
  ...
  capabilities: [
    {
      ...
      schema_request:
        "https://commandlayer.org/schemas/v1.0.0/commons/classify/requests/classify.request.schema.json",
      schema_receipt:
