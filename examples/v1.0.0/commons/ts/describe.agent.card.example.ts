...
export const describeAgentCard: AgentCard = {
  ...
  description:
    "Describes entities, objects, or content using the CommandLayer Commons v1.0.0 describe verb.",
  ...
  capabilities: [
    {
      ...
      schema_request:
        "https://commandlayer.org/schemas/v1.0.0/commons/describe/requests/describe.request.schema.json",
      schema_receipt:
