...
export const formatAgentCard: AgentCard = {
  ...
  description:
    "Formats content without changing semantics using the CommandLayer Commons v1.0.0 format verb.",
  ...
  capabilities: [
    {
      ...
      schema_request:
        "https://commandlayer.org/schemas/v1.0.0/commons/format/requests/format.request.schema.json",
      schema_receipt:
