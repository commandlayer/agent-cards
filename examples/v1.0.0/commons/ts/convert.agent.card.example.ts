...
export const convertAgentCard: AgentCard = {
  ...
  description:
    "Converts content between formats using the CommandLayer Commons v1.0.0 convert verb.",
  ...
  capabilities: [
    {
      ...
      schema_request:
        "https://commandlayer.org/schemas/v1.0.0/commons/convert/requests/convert.request.schema.json",
      schema_receipt:
