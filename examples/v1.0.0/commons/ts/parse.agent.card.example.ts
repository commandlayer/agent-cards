...
export const parseAgentCard: AgentCard = {
  ...
  description:
    "Parses unstructured or semi-structured content using the CommandLayer Commons v1.0.0 parse verb.",
  ...
  capabilities: [
    {
      ...
      schema_request:
        "https://commandlayer.org/schemas/v1.0.0/commons/parse/requests/parse.request.schema.json",
      schema_receipt:
