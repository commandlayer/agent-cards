...
export const analyzeAgentCard: AgentCard = {
  ...
  description:
    "Analyzes content using the CommandLayer Commons v1.0.0 analyze verb.",
  ...
  capabilities: [
    {
      ...
      schema_request:
        "https://commandlayer.org/schemas/v1.0.0/commons/analyze/requests/analyze.request.schema.json",
      schema_receipt:
