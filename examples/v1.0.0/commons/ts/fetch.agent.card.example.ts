...
export const fetchAgentCard: AgentCard = {
  ...
  description:
    "Fetches external data using the CommandLayer Commons v1.0.0 fetch verb.",
  ...
  capabilities: [
    {
      ...
      schema_request:
        "https://commandlayer.org/schemas/v1.0.0/commons/fetch/requests/fetch.request.schema.json",
      schema_receipt:
