...
The underlying Protocol-Commons / Commercial schemas
...
Do not silently “fix” it in public.

File an Issue, or if sensitive, follow SECURITY.md and email dev@commandlayer.org (PGP encouraged).
...
You can credibly claim Agent-Cards compliant if:
 ...
 Commons vs Commercial classes are used correctly.
